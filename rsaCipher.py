...
def main():
    ...
    if mode == 'encrypt':
        ...
        pubKeyFilename = 'Jinseok Choi_pubkey.txt'
        ...
        privKeyFilename = 'Jinseok Choi_privkey.txt'
...
def encryptMessage(message, key, blockSize=DEFAULT_BLOCK_SIZE):
    ...
    for block in getBlocksFromText(message, blockSize):
        ...
        print (block) #23~24장 pdf파일 33page Hello world! 의 sum값 출력
        encryptedBlocks.append(pow(block, e, n)) #  pow(block, e, n) == block^e mod n
