...
import os, re, copy, pprint, pyperclip, simpleSubCipher, WordPattern

if not os.path.exists('wordPatterns.py'):
    WordPattern.main() # create the wordPatterns.py file
import wordPatterns
...
def hackSimpleSub(message):
    ...
    for cipherword in cipherwordList:
        ...
        wordPattern = WordPattern.getWordPattern(cipherword)
